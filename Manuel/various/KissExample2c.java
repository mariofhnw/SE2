 ...
 * 
 * A more object-oriented solution: specialized controls are defined in their
 * own classes. In a real application, the new classes should be in their own
 * files.
 */
public class KissExample2c extends JFrame implements ActionListener {
